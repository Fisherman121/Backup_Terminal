terminal.addCommand("watti", async function(args) {
    if (args.action == "list") {
        const result = await fetch("https://www.viren-bahure.de/walk-to-college/api/get_walks.php")
        ...
        let url = "https://www.viren-bahure.de/walk-to-college/api/add_walk.php?"
